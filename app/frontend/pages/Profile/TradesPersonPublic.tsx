          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between">
              <div className="flex items-start space-x-6 mb-6 md:mb-0">
                {/* Profile Avatar */}
                <div className="w-24 h-24 bg-blue-100 rounded-full overflow-hidden flex-shrink-0 border-2 border-white shadow-lg">
                ...
                <Button
                  ...
                  onClick={() => {
                    if (navigator.share) {
                      navigator.share({
                        title: `${profile.company_name || 'Professional'} - Tradesperson Profile`,
                        text: `Check out this ${profile.skills.length > 0 ? profile.skills[0].name.toLowerCase() + ' specialist' : 'tradesperson'} on our platform!`,
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-gray-500 mb-4">
                    Be the first to leave a review for this tradesperson!
                  </p>
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <p className="text-blue-700 text-xs text-center">
                      We&apos;re building a comprehensive review system to help
