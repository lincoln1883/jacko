...
describe('SupplierEdit', () => {
  ...
  describe('Rendering', () => {
    it('renders the edit form with all fields', async () => {
      await act(async () => {
        render(<SupplierEdit {...defaultProps} />);
      });
    ...
    it('displays navigation links', async () => {
      ...
      expect(viewProfileLink).toHaveAttribute('href', '/profile/supplier');
      expect(cancelLink).toHaveAttribute('href', '/profile/supplier');
    });
  });
  ...
  describe('Form interactions', () => {
    ...
    it('submits the form with correct data', async () => {
      ...
      expect(mockPut).toHaveBeenCalledWith('/profile/supplier');
    });
  ...
  describe('Error handling', () => {
    it('displays field validation errors', async () => {
      ...
      await act(async () => {
        render(<SupplierEdit {...propsWithErrors} />);
      });
  ...
  describe('Profile completion visualization', () => {
    it('shows appropriate completion color for high completion', async () => {
      ...
      await act(async () => {
        render(
          <SupplierEdit {...defaultProps} profile={highCompletionProfile} />
        );
      });
    ...
    it('shows appropriate completion color for medium completion', async () => {
      ...
      await act(async () => {
        render(
          <SupplierEdit {...defaultProps} profile={mediumCompletionProfile} />
        );
      });
    ...
    it('shows appropriate completion color for low completion', async () => {
      ...
      await act(async () => {
        render(
          <SupplierEdit {...defaultProps} profile={lowCompletionProfile} />
        );
      });
