...
describe('Input Component', () => {
  describe('Basic rendering', () => {
    it('renders a basic input without label', () => {
      ...
      expect(input.type).toBe('text'); // Check the DOM property instead
    });
  ...
  describe('Error handling', () => {
    ...
    it('hides hint when errors are present', () => {
      render(<Input label="Email" hint="Enter your email" errors={['Invalid email']} />);
  ...
  describe('Edge cases', () => {
    ...
    it('handles very long error messages', () => {
      const longError = 'This is a very long error message that might wrap to multiple lines and should be handled gracefully';
