...
describe('Label Component', () => {
  ...
  describe('Forward ref functionality', () => {
    ...
    it('allows ref access to label properties', () => {
      ...
      expect(labelRef?.textContent).toBe('Reference Test');
      expect(labelRef?.getAttribute('for')).toBe('test-input');
    });
  });
  ...
  describe('Content handling', () => {
    ...
    it('handles long text content', () => {
      const longText = 'This is a very long label text that should wrap properly and maintain readability';
      ...
      render(
        <form>
          <Label htmlFor="required-field">
            Required Field
            <span aria-label="required" role="img">*</span>
          </Label>
  ...
  describe('Performance considerations', () => {
    ...
    it('handles dynamic prop updates correctly', () => {
      const { rerender } = render(<Label htmlFor="input-1">Original Label</Label>);
      
      expect(screen.getByText('Original Label')).toHaveAttribute('for', 'input-1');
      
      rerender(<Label htmlFor="input-2">Updated Label</Label>);
      
      expect(screen.getByText('Updated Label')).toHaveAttribute('for', 'input-2');
    });
  });
});
