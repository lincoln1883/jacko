...
describe('FlashMessageComponent', () => {
  ...
  describe('Basic rendering', () => {
    it('renders notice flash message correctly', () => {
      ...
      expect(
        screen.getByText('Success! Data saved successfully.')
      ).toBeInTheDocument();
    ...
    it('renders default flash message with alert icon', () => {
      const flash = {
        type: 'info' as FlashMessage['type'],
  ...
  describe('Variant styling', () => {
    ...
    it('applies default variant for unknown message types', () => {
      const flash = {
        type: 'unknown' as FlashMessage['type'],
  ...
  describe('Content rendering', () => {
    it('handles long messages correctly', () => {
      const longMessage =
        'This is a very long flash message that should wrap properly and maintain readability even with extended content that might span multiple lines.';
