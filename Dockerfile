...
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name jacko jacko
...
# Install packages needed to build gems and Node.js for frontend assets
RUN apt-get update -qq && \
